    ...
    function getcols($act) {
        switch ($act) {
            case 'list':
                return '*';
            case 'modify':
                return 'aid,title,subtitle,catid,typeid,tag,spid,toppost,introduce,introduce_len,mtitle,description,keyword,image,thumb,content,isecoding,checked,template,showform,pics,linkto,grade,htmlrule,ishtml,attr1,attr2,listorder,attr3,adddate'.$this->mycols();
            case 'manage':
                return '*';
            case 'user_modify':

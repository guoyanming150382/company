...
class category extends table {
    ...
    function getcols($act) {
        if ($act == 'modify')
            return 'catid,catname,subtitle,parentid,htmldir,template,ismobilenav,listtemplate,showtemplate,showform,ishtml,isshow,ispages,includecatarchives,linkto,meta_title,htmlrule,listhtmlrule,showhtmlrule,categorycontent,image,thumb_width,thumb_height,description,keyword,scategory,isnav,attr3';
        else return 'catid,catname,htmldir,isshow,ispages,linkto,scategory,ismobilenav,attr3';
    }
    function get_form() {
        return array(
                'parentid'=>array(
